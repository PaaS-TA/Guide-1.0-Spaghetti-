...
2. 서비스
	...
	- 2.1.1. Cubrid (
	[vSphere](./Service-Guide/DBMS/OpenPaaS_PaaSTA_ServicePack_Cubrid_vSphere_install_guide.md), 
	...
	- 2.2.1. Mongodb (
	[vSphere](./Service-Guide/NOSQL/OpenPaaS_PaaSTA_ServicePack_MongoDB_vSphere_install_guide.md), 
	...
	- 2.2.2. Redis (
	[vSphere](./Service-Guide/NOSQL/ServicePack_Redis_AWS_install_guide.md), 
	[AWS](), 
	[OpenStack](), 
	[Bosh-Lite]())
	...
	- 2.3.1. GlusterFS (
	[vSphere](./Service-Guide/Storage/OpenPaaS_PaaSTA_ServicePack_GlusterFS_vSphere_install_guide.md), 
