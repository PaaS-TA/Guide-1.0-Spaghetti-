...
![그림 2-1 개방형 클라우드 플랫폼에서의 어플리케이션 배포 프로세스][buildpack_develope_guide_01]개방형 클라우드 플랫폼에 배포되는 어플리케이션은 크게
...
![그림2-2 빌드팩 런타임 아키텍처][buildpack_develope_guide_02]빌드팩은 어플리케이션 배포 프로세스의 스테이지 단계에서
