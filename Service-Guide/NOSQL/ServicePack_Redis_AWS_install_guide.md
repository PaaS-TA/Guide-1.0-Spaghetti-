...
>![./image/redis_aws/redis_aws13]

- Redis서비스팩을 배포한다.

><div>$bosh deploy</div>
>![./image/redis_aws/redis_aws14]
>![./image/redis_aws/redis_aws15]

- 배포된 Redis서비스팩을 확인한다.

><div>$bosh vms</div>
>![./image/redis_aws/redis_aws16]
...
>![./image/redis_aws/redis_aws18]

- 등록된 Redis 서비스 브로커를 확인한다.

><div>$cf service-brokers</div>
>![./image/redis_aws/redis_aws19]

- 접근 가능한 서비스 목록을 확인한다.

><div>$cf service-access</div>
>![./image/redis_aws/redis_aws20]
...
>![./image/redis_aws/redis_aws24]

- 생성된 Redis 서비스 인스턴스를 확인한다.

><div>$cf services</div>
>![./image/redis_aws/redis_aws25]
...
![./image/redis_aws/redis_aws44]

- 접속이 완료되고 좌측 서버 정보를 더블 클릭하면 좌측에 스키마 정보가 나타난다.<br>
![./image/redis_aws/redis_aws45]

- 신규 키 등록후 확인<br>
![./image/redis_aws/redis_aws46]
