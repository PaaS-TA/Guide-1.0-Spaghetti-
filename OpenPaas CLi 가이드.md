...
#### delete-quota
  ...
  |-------------|--------------------------------|-----------|
  |QUOTA        |QUOTA명                                                       |O         |
  |-f           |삭제 확인메시지 없이 QUOTA 정보를 삭제합니다.                       |X         |
...
#### delete-space-quota
  ...
  |-------------|--------------------------------|-----------|
  |SPACE-QUOTA-NAME     |스페이스 QUOTA명                                     |O         |
  |-f           |삭제 확인메시지 없이 SPACE-QUOTA 정보를 삭제합니다.               |X         |
...
#### delete-service-auth-token
  ...
  |LABEL        |서비스 토큰 라벨                 |O         |
  |PROVIDER     |서비스 제공자                    |O         |
  |-f           |삭제 확인메시지 없이 SERVICE TOKEN 정보를 삭제합니다.      |X         |
...
#### delete-service-broker
  ...
  |-f                |삭제 확인메시지 없이 SERVICE BROKER 정보를 삭제합니다.       |X         |
